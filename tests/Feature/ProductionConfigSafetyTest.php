 ...
 * of quietly serving stack traces.
 */
class ProductionConfigSafetyTest extends TestCase
{
    ...
    {
        $violations = ProductionConfigGuard::violations('production', true);
    ...
    {
        $this->assertSame([], ProductionConfigGuard::violations('production', false));
    }

    public function test_non_production_environments_are_left_alone(): void
    {
        $this->assertSame([], ProductionConfigGuard::violations('local', true));
        $this->assertSame([], ProductionConfigGuard::violations('testing', true));
    }
